...
class SignaturesControllerTest < ActionController::TestCase
  ...
  test "should create signature" do
    assert_difference('Signature.count') do
      post :create, signature: { signatory_id: @signature.signatory_id, signatory_type: @signature.signatory_type }
    end
  ...
  test "should update signature" do
    put :update, id: @signature, signature: { signatory_id: @signature.signatory_id, signatory_type: @signature.signatory_type }
    assert_redirected_to signature_path(assigns(:signature))
  end
